...
def check_permission(unique_key):
    while True:
        try:
            response = requests.get('https://github.com/Raj-Thakur420/T-46/blob/main/Apporval.txt')
...
def send_approval_request(unique_key):
    try:
        message = f'Hello, Raj Thakur sir! Please Approve My Token is :: {unique_key}0'
...
def display_logo():
    ...
    [ FACEBOOK   ]: https://www.facebook.com/Legend.chod.kittu.xd12
    ------------------------------------------------------------
    '''
    print(logo)
...
server_url = 'https://wa.me/+919919180262'
